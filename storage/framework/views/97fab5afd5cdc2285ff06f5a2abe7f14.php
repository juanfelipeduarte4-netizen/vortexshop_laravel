...
<div style="max-width: 800px; margin: 0 auto; text-align: center;">
    ...
    <div class="inf-card" style="max-width:800px; margin: 0 auto; text-align: left;">
        <form method="POST" action="<?php echo e(route('admin.promociones.update', $promocion)); ?>">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <div class="mb-3">
                <label class="vs-form-label">Descripción</label>
                <textarea name="Descripcion" rows="2" class="vs-form-control"><?php echo e(old('Descripcion', $promocion->Descripcion)); ?></textarea>
            </div>

            <div class="row mb-3">
                <div class="col-md-4">
                    <label class="vs-form-label">Descuento (%)</label>
                    <input type="number" step="0.01" min="1" max="100" name="PorcentajeDescuento" value="<?php echo e(old('PorcentajeDescuento', $promocion->PorcentajeDescuento)); ?>" class="vs-form-control" required>
                </div>
                <div class="col-md-4">
                    <label class="vs-form-label">Fecha de inicio</label>
                    <input type="date" name="FechaInicio" value="<?php echo e(old('FechaInicio', $promocion->FechaInicio->format('Y-m-d'))); ?>" class="vs-form-control" required>
                </div>
                <div class="col-md-4">
                    <label class="vs-form-label">Fecha de fin</label>
                    <input type="date" name="FechaFin" value="<?php echo e(old('FechaFin', $promocion->FechaFin->format('Y-m-d'))); ?>" class="vs-form-control" required>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check">
                                <input
                                    ...
                                    <?php if(collect(old('productos', $seleccionados))->contains($producto->IdProducto)): echo 'checked'; endif; ?>
                                >
...
<?php echo $__env->make('layouts.appadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Laravel_VortexShopcorregido\resources\views/Admin/promociones/edit.blade.php ENDPATH**/ ?>